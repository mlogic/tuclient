...
class TestCollectdOS(unittest.TestCase):
    ...
    def test_parsing_data(self):
        ...
        try:
            ...
            self.assertEqual(
                [97, 0, 0, 0, 0, 0, 1, 0, 99, 0, 0, 0, 0, 2, 0, 0, 100, 0, 0, 0, 0, 0, 1, 0, 97, 0, 1, 0, 0, 0, 1, 0,
                 96, 0, 1, 0, 0, 1, 2, 0, 98, 0, 0, 0, 0, 0, 1, 0, 98, 0, 0, 0, 0, 0, 0, 0, 98, 0, 0, 0, 0, 0, 0, 0],
                collectd_os.collect())
            collectd_os._on_receiving_cpu_data('host_a', 'cpu',
                                               [(0, 'host_a'), (8, 1552233783.7933807), (9, 1073741824), (2, 'cpu'),
                                                ...
                                                (5, 'wait'), (6, [(2, 180)])])
            self.assertEqual(
                [99, 0, 0, 0, 0, 0, 1, 0, 98, 0, 0, 0, 0, 0, 1, 0, 97, 0, 0, 0, 0, 1, 1, 0, 98, 0, 1, 0, 0, 0, 0, 0, 99,
                 0, 0, 0, 0, 0, 1, 0, 99, 0, 0, 0, 0, 0, 1, 0, 98, 0, 1, 0, 0, 1, 1, 0, 99, 0, 0, 0, 0, 0, 0, 0],
                collectd_os.collect())
            collectd_os._on_receiving_cpu_data('host_a', 'cpu',
                                               [(0, 'host_a'), (8, 1552233784.793299), (9, 1073741824), (2, 'cpu'),
                                                ...
                                                (5, 'interrupt'), (6, [(2, 0)])])
            self.assertEqual(
                [98, 0, 1, 1, 0, 0, 0, 0, 96, 0, 0, 0, 0, 0, 4, 0, 97, 0, 0, 0, 0, 2, 2, 0, 99, 0, 0, 0, 0, 1, 1, 0, 96,
                 0, 0, 0, 0, 1, 0, 3, 95, 0, 1, 0, 0, 0, 1, 3, 97, 0, 0, 0, 0, 0, 1, 0, 99, 0, 0, 0, 0, 1, 0, 0],
                collectd_os.collect())
        finally:
            collectd_os.stop()
